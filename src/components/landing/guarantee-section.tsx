    ...
    return (
        <section className="py-[50px] md:py-[100px] px-[20px] bg-zinc-950 w-full relative overflow-hidden border-b border-zinc-900">
            ...
            <div className="w-full max-w-[1100px] mx-auto relative z-10">
                <div className="bg-zinc-900/40 border border-zinc-800 rounded-[2.5rem] p-8 md:p-16 backdrop-blur-sm flex flex-col md:flex-row items-start md:items-center gap-12 hover:border-emerald-500/20 transition-all duration-500 group">
