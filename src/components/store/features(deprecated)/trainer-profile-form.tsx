...
export function TrainerProfileForm({ profile }: ClientProfileFormProps) {
        ...
        <form action={handleSubmit} className="space-y-10">
                    ...
                    <div className="flex-1 space-y-6">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="bg-zinc-900/50 border-zinc-800 focus:border-emerald-500/50 rounded-system h-12 font-bold text-zinc-100"
                                required
                            />
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="bg-zinc-900/50 border-zinc-800 focus:border-emerald-500/50 rounded-system h-12 uppercase font-mono tracking-widest text-zinc-400"
                                readOnly
                            />
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="bg-zinc-900/50 border-zinc-800 focus:border-emerald-500/50 rounded-system h-12 text-zinc-100"
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input
                                ...
                                className="bg-zinc-900/50 border-zinc-800 focus:border-emerald-500/50 rounded-system h-12 pl-10 text-zinc-100"
                            />
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-2">
                        ...
                        <Input
                            ...
                            className="bg-zinc-900/50 border-zinc-800 focus:border-emerald-500/50 rounded-system h-10 text-[10px] text-zinc-400"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="space-y-2">
                ...
                <Textarea
                    ...
                    className="bg-zinc-900/50 border-zinc-800 focus:border-emerald-500/50 rounded-system min-h-[120px] resize-none p-4 text-zinc-100"
                />
            </div>

            <Button
                type="submit"
                className="w-full bg-emerald-500 hover:bg-emerald-400 text-black font-black uppercase tracking-widest h-14 rounded-system shadow-[0_0_20px_-5px_rgba(16,185,129,0.3)] transition-all active:scale-95"
            >
