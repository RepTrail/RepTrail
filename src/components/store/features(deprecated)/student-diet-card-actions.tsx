    ...
    return (
        <div className="mt-auto pt-6 border-t border-zinc-800/50 flex items-center gap-2">
            <UnifiedAssignDialog
                ...
                trigger={
                    <Button
                        className="flex-1 min-w-0 w-full h-9 bg-orange-500 hover:bg-orange-400 text-zinc-950 rounded-system text-[10px] font-black uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-1.5 px-6"
                    >
            ...
            />
            <Button asChild variant="outline" className="flex-1 min-w-0 w-full h-9 bg-zinc-800 border-zinc-700 text-zinc-100 hover:bg-zinc-700 flex items-center justify-center gap-1.5 rounded-system font-black text-[10px] uppercase italic tracking-widest border-white/5 px-6">
