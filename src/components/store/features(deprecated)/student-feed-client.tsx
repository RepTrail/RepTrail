            ...
            {publicPhotos.map((photo: any, index: number) => {
                ...
                return (
                    <Link
                        ...
                        className="group block relative rounded-system overflow-hidden border border-zinc-900 bg-zinc-950 hover:border-emerald-500/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.1)] transition-all duration-500"
                    >
                        {/* Image Container */}
                        ...
                        <div className="absolute inset-x-4 bottom-4 p-4 rounded-system bg-zinc-900/80 backdrop-blur-xl border border-white/5 flex items-center justify-between group-hover:translate-y-[-4px] transition-transform duration-500">
                            ...
                            <div className="w-10 h-10 flex items-center justify-center bg-emerald-500 text-zinc-950 rounded-system group-hover:rotate-[360deg] transition-all duration-700 shadow-lg shadow-emerald-500/20">
