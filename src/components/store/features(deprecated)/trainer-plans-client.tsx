...
export function PlansClient({ currentTier, studentCount, profile }: PlansClientProps) {
    ...
    return (
        <RegistryMain
            ...
            showTabs={false}
        >
            <Stack gap={STORE_TOKENS.SPACING.EMPTY_STATE} suppressHydrationWarning>
                <PaymentModal
                    isOpen={isModalOpen}
                ...
                {/* Plan Card */}
                <div className="relative rounded-system overflow-hidden border border-zinc-800 bg-zinc-950 shadow-2xl">
                    ...
                    <div className="p-4 space-y-8">
                        ...
                        {/* Calculator */}
                        <div className="space-y-4 bg-zinc-900/50 rounded-system p-5 border border-zinc-800">
                            ...
                            {/* Result */}
                            <div className="rounded-system bg-zinc-950 border border-zinc-800 p-4 space-y-2">
                        ...
                        {profile?.is_billing_exempt ? (
                            <div className="flex items-center gap-3 pb-4p-6 rounded-system bg-amber-500/10 border border-amber-500/20 shadow-xl shadow-amber-950/20 p-4">
                            ...
                            <div className="flex items-center gap-3 p-4 rounded-system bg-emerald-500/5 border border-emerald-500/20">
                            ...
                            <div className="flex flex-col gap-4">
                                {monthlyTotal === 0 ? (
                                    <Button
                                        ...
                                        className="w-full h-14 rounded-system bg-emerald-500 hover:bg-emerald-600 text-zinc-950 font-black uppercase tracking-widest text-sm gap-3 transition-all hover:scale-[1.02] active:scale-[0.98]"
                                    >
                                    ...
                                    <Button
                                        ...
                                        /* ❌ UI BLOCKING REMOVED */ disabled={false}
                                        className="w-full h-14 rounded-system bg-white hover:bg-zinc-100 text-zinc-950 font-black uppercase tracking-widest text-sm gap-3 transition-all hover:scale-[1.02] active:scale-[0.98]"
                                    >
                                        <Zap className="w-5 h-5 fill-current" />
