...
export function TrainerProfileClient({ profile, activeStudents }: TrainerProfileClientProps) {
    ...
    return (
        <RegistryMain
            ...
            showTabs={false}
        >
            <Grid gap={STORE_TOKENS.SPACING.CONTAINER} lgCols={12}>
                {/* Main Settings */}
                <div className="lg:col-span-8">
                    <Card className="bg-zinc-950 border-zinc-800 shadow-2xl overflow-hidden rounded-system border-t-zinc-700/50">
                ...
                <div className="lg:col-span-4 space-y-6">
                    <Card className="bg-zinc-950 border-zinc-800 shadow-2xl rounded-system overflow-hidden group">
                        ...
                        <CardContent className="p-6 space-y-6">
                            <div className="flex flex-col items-center justify-center py-4 bg-zinc-900/30 rounded-system border border-zinc-800/50 border-dashed">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 bg-zinc-900/50 rounded-system border border-zinc-800/50 text-center">
                    ...
                    <Card className="bg-zinc-950 border-zinc-800/50 shadow-2xl rounded-system overflow-hidden group relative text-left">
                        ...
                        <CardContent className="p-8 space-y-6 flex flex-col items-center relative z-10">
                            ...
                            {profile?.asaas_subscription_id ? (
                                ...
                                <Link href="/dashboard/trainer/plans" className="w-full">
                                    <Button className="w-full h-12 rounded-system bg-white text-zinc-950 hover:bg-purple-500 hover:text-white font-black uppercase italic tracking-widest text-xs transition-all shadow-xl">
                                        Explorar Planos
