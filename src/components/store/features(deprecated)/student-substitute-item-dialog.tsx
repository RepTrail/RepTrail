...
export function SubstituteItemDialog({ item, onSuccess }: SubstituteItemDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="bg-zinc-950 border-zinc-900 text-white rounded-system">
                <DialogHeader>
                ...
                <div className="space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="bg-zinc-900 border-zinc-800 rounded-system"
                        />
                    </div>
                    <div className="space-y-2">
                ...
                <DialogFooter>
                    <Button
                        ...
                        className="w-full bg-white text-zinc-950 hover:bg-zinc-200 font-black uppercase italic tracking-widest rounded-system"
                    >
