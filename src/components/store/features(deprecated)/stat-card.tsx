...
export function StatCard({ label, value, unit, trend, trendVal, trendLabel, icon }: StatCardProps) {
    return (
        <Card className="bg-zinc-900/40 border-zinc-800/50 shadow-2xl rounded-system overflow-hidden group backdrop-blur-sm transition-all hover:border-zinc-700/50 relative">
            <CardHeader className="p-6 sm:p-8 relative z-10">
                ...
                <div className="flex items-center gap-2 mt-6 bg-zinc-950/30 w-fit px-3 py-1.5 rounded-system border border-zinc-800/50">
