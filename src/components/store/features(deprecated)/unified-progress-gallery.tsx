...
export function UnifiedProgressGallery({ photos, mode = 'public', studentName, studentId }: UnifiedProgressGalleryProps) {
    ...
    if (photos.length === 0) {
        return (
            <div className="py-20 flex flex-col items-center justify-center text-zinc-500 gap-3 border-2 border-dashed border-zinc-900 rounded-system bg-zinc-900/20">
        ...
        return (
            ...
            >
                ...
                <div
                    ...
                    className="aspect-[3/4] relative rounded-system overflow-hidden border border-white/5 bg-zinc-900 transition-all hover:scale-[0.98] cursor-zoom-in shadow-xl group-hover:border-emerald-500/30"
                >
                    <Image
                        src={item.url}
                        alt="Progresso"
                            ...
                            <div key={set.id} className="space-y-6 pt-10 first:pt-0 border-t border-zinc-900 first:border-none">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-2">
                                    <div className="flex items-center gap-4">
                                        <div className="h-10 w-10 rounded-system bg-zinc-900 flex items-center justify-center border border-white/5">
                                                ...
                                                {isEditing ? (
                                                    <div className="flex items-center gap-2 animate-in fade-in slide-in-from-right-4 duration-300">
                                                        <Input
                                                            ...
                                                            className="h-8 w-36 px-3 text-[11px] bg-zinc-900 border-zinc-800 text-white rounded-system focus:ring-emerald-500/20"
                                                        />
                                                        <div className="flex gap-1">
                                                            ...
                                                            <Button size="icon" variant="ghost" onClick={() => setEditingSetId(null)} /* ❌ UI BLOCKING REMOVED */ disabled={false} className="h-8 w-8 text-zinc-500 hover:text-white hover:bg-zinc-800 rounded-system">
                                                                <X className="w-4 h-4" />
                                                            </Button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="px-1 flex items-center justify-between">
                                        {isEditing ? (
                                            <div className="flex items-center gap-1 w-full animate-in fade-in zoom-in duration-300">
                                                ...
                                                />
                                                <div className="flex gap-1">
                                                    <Button size="icon" variant="ghost" onClick={() => handleDateSave(item.setId)} /* ❌ UI BLOCKING REMOVED */ disabled={false} className="h-7 w-7 p-0 bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500 hover:text-white rounded-system transition-all">
                                                        <Check className="w-3.5 h-3.5" />
                                                    </Button>
                                                    <Button size="icon" variant="ghost" onClick={() => setEditingSetId(null)} /* ❌ UI BLOCKING REMOVED */ disabled={false} className="h-7 w-7 p-0 bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white rounded-system transition-all">
                                            ...
                                            <div className="flex items-center justify-between w-full group/date">
                                                ...
                                                <Button
                                                    ...
                                                    className="h-6 w-6 p-0 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-white/10 text-zinc-500 hover:text-white rounded-system"
                                                >
                ...
                <DialogContent className="max-w-[95vw] w-full max-h-[95vh] p-0 border-none bg-black/95 backdrop-blur-2xl flex items-center justify-center transition-all duration-300" showCloseButton={false}>
                    ...
                    {selectedPhotoIndex !== null && (
                        <div className="relative w-full h-full flex items-center justify-center p-4">
                            ...
                            {/* Info Overlay */}
                            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 bg-zinc-900/80 backdrop-blur-md px-6 py-4 rounded-system border border-white/10 flex items-center gap-8 shadow-2xl animate-in slide-in-from-bottom-4 duration-500">
