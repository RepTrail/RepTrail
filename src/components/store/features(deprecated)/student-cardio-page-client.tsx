'use client';
import { CardioInfoCard } from './student-cardio-info-card'
...
export function CardioPageClient({ userId }: CardioPageClientProps) {
    ...
    return (
        <Stack gap={STORE_TOKENS.SPACING.EMPTY_STATE}>
            ...
            <Grid gap={STORE_TOKENS.SPACING.EMPTY_STATE} lgCols={12}>
                                    ...
                                    <>
                                        {cardios.length > 0 ? (
                                            cardios.map((cardio: any) => {
                                                ...
                                                return (
                                                    <Card key={cardio.id} className="bg-zinc-900/50 border-zinc-800 text-zinc-100 hover:border-orange-500/30 transition-all group rounded-system overflow-hidden">
                                                        <CardHeader className="pb-2">
                                                            <div className="flex items-start justify-between">
                                                                ...
                                                                <UnifiedDeleteButton
                                                                    ...
                                                                    studentId={userId}
                                                                    className="text-zinc-600 hover:text-red-400 hover:bg-red-400/10 rounded-system transition-all"
                                                                    queryKey={QUERY_KEYS.cardio.library(userId)}
                                                                />
                                                            </div>
                                                        ...
                                                        <CardContent>
                                                            ...
                                                            <div className="mt-auto pt-6 border-t border-zinc-800/50 flex items-center gap-2">
                                                                <UnifiedAssignDialog
                                                                    ...
                                                                    trigger={
                                                                        <Button className="flex-1 min-w-0 h-9 bg-orange-500 hover:bg-orange-400 text-zinc-950 rounded-system text-[10px] font-black uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-1.5 px-6">
                ...
                <div className="lg:col-span-4 space-y-10">
                    <div className="space-y-6">
                        ...
                        <Card className="bg-zinc-900/40 border-zinc-800/50 rounded-system p-6 sm:p-10 backdrop-blur-sm shadow-xl">
                            <div className="space-y-6">
