...
export function LoadProgressionChart({ data }: LoadProgressionChartProps) {
    ...
    if (exerciseHistory.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-10 text-center space-y-3 bg-zinc-950/30 rounded-system border border-dashed border-zinc-800">
    ...
    return (
        <div className="grid gap-6 md:grid-cols-3">
            {exerciseHistory.map(([name, history]: any) => (
                <Card key={name} className="bg-zinc-950/50 border-zinc-800/80 rounded-system overflow-hidden group hover:border-emerald-500/30 transition-all">
                    ...
                    <CardContent className="p-6 pt-0">
                        ...
                        <div className="mt-4 flex items-center justify-between">
                            ...
                            <div className="p-2 bg-emerald-500/10 rounded-system border border-emerald-500/20">
