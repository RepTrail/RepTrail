        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                ...
                {exercises.length > 0 ? (
                                ...
                                <CardContent className="p-0">
                                    ...
                                    <div className="p-6 flex flex-col gap-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            {/* WARMUP */}
                                            <div className="space-y-4 p-4 rounded-system bg-zinc-900/40 border border-zinc-800/80 hover:border-zinc-700/50 transition-colors">
                                            ...
                                            {/* WORKING */}
                                            <div className="space-y-4 p-4 rounded-system bg-blue-500/5 border border-blue-500/20 ring-1 ring-blue-500/10">
                    ...
                    <div className="p-8 text-center border-2 border-dashed border-zinc-800 rounded-system">
            ...
            {/* Selector */}
            <div className="bg-zinc-900/50 p-6 rounded-system border border-zinc-800 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mt-4 animate-in fade-in slide-in-from-top-2">
                        {searchResults.map((ex) => (
                            <Button
                                ...
                                className="justify-start bg-zinc-950 border-zinc-800 hover:border-zinc-700 hover:bg-zinc-900 h-auto py-3 px-4 text-zinc-300 rounded-system"
                            >
                ...
                {searchQuery.length >= 2 && !isSearching && searchResults.length === 0 && (
                    <div className="p-4 bg-zinc-950 rounded-system border border-zinc-800 flex items-center justify-between gap-4">
            ...
            <div className="pt-12 flex justify-center border-t border-zinc-800/30">
                <Button
                    asChild
                    variant="ghost"
                    className="w-full sm:w-auto text-zinc-500 hover:text-white hover:bg-zinc-900 gap-2 px-6 h-auto py-4 rounded-system transition-all whitespace-normal text-center"
                >
