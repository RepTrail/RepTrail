            ...
            <div className="grid grid-cols-3 gap-2 md:gap-4">
                {filteredItems.map((item, i) => (
                    <div
                        ...
                        className="group aspect-[3/4] relative rounded-system overflow-hidden border border-white/5 bg-zinc-900 transition-all hover:scale-[0.98] cursor-zoom-in"
                    >
                        <Image
                            src={item.url}
                            alt="Progresso"
                        ...
                        <div className="absolute bottom-2 left-2 bg-black/60 backdrop-blur-md px-2 py-1 rounded-system text-[7px] font-black uppercase tracking-tight text-white/70">
                ...
                {filteredItems.length === 0 && (
                    <div className="col-span-3 py-20 flex flex-col items-center justify-center rounded-system border border-dashed border-zinc-800 text-zinc-600 space-y-2">
