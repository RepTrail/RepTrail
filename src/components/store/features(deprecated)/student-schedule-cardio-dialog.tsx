        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button 
                    variant="outline" 
                    size="sm" 
                    className="bg-zinc-900 border-zinc-700 hover:bg-zinc-800 hover:text-white flex items-center gap-2 rounded-system text-[9px] font-black uppercase tracking-widest leading-none h-9 flex-1"
                >
            ...
            <DialogContent className="sm:max-w-[425px] bg-zinc-950 text-white border-zinc-800 rounded-system">
                ...
                <div className="space-y-6 py-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                type="number"
                                className="bg-zinc-900 border-zinc-800 text-white rounded-system h-12"
                                value={duration}
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={intensity} onValueChange={setIntensity}>
                                <SelectTrigger className="bg-zinc-900 border-zinc-800 text-white rounded-system h-12">
                                    <SelectValue />
                                </SelectTrigger>
                ...
                <DialogFooter>
                    <Button onClick={handleSchedule} className="w-full bg-emerald-500 text-zinc-950 hover:bg-emerald-600 font-black uppercase italic rounded-system h-12 transition-all">
                        Salvar Cronograma
                    </Button>
                </DialogFooter>
            </DialogContent>
