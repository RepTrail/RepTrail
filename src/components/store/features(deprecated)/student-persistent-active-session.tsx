    ...
    return (
        ...
        >
            <div className="relative group">
                ...
                <Link href={href}>
                    <div className="bg-zinc-950/90 backdrop-blur-xl border border-orange-500/40 rounded-system p-3 md:p-4 flex items-center justify-between shadow-[0_20px_50px_rgba(0,0,0,0.6)] group-hover:border-orange-500/60 transition-all active:scale-[0.98] ring-1 ring-white/5">
                        <div className="flex items-center gap-3 pb-4md:gap-4 overflow-hidden">
                            <div className="w-10 h-10 md:w-12 md:h-12 bg-orange-500/20 rounded-system flex items-center justify-center border border-orange-500/30 relative shrink-0">
