        ...
        <Card className={cn(
            ...
            <CardContent className="p-6 pt-0 flex-1 flex flex-col">
                <div className="flex-1">
                    {uniqueDays.length > 0 ? (
                        <div className="flex flex-wrap gap-1.5 mb-6">
                            {uniqueDays.map((day) => (
                                <span key={day} className={cn("flex items-center shrink-0 gap-1 px-2 py-1 text-[9px] font-black uppercase rounded-system border", colors.badge)}>
                        ...
                        <div className="flex items-center gap-1 px-2 py-1 bg-zinc-800/50 text-zinc-500 text-[9px] font-black uppercase rounded-system border border-zinc-800 mb-6 w-fit">
                            <Calendar className="w-2.5 h-2.5" />
                            Não agendado
                        </div>
                    )}
                ...
                <div className="mt-auto pt-6 border-t border-zinc-800/50">
                    <Button asChild className={cn("w-full h-10 rounded-system text-[10px] font-black uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2", colors.button)}>
                        <Link href={href}>
                            {onEditLabel}
                        </Link>
                    </Button>
