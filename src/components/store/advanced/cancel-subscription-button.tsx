...
export function CancelSubscriptionButton() {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[480px] bg-zinc-950 border-zinc-800/50 text-zinc-100 p-0 overflow-hidden rounded-system shadow-2xl">
                ...
                <div className="p-8 space-y-8 relative z-10">
                    <div className="flex flex-col items-center text-center space-y-4">
                        <div className="w-20 h-20 rounded-system bg-red-500/10 border border-red-500/20 flex items-center justify-center group-hover:scale-110 transition-transform shadow-2xl">
                    ...
                    <div className="space-y-4">
                        <div className="p-5 bg-zinc-900/50 border border-zinc-800 rounded-system space-y-3">
                    ...
                    <DialogFooter className="flex flex-col sm:flex-row gap-3 pt-4">
                        <Button
                            ...
                            className="flex-1 h-14 bg-zinc-900 border-zinc-800 text-zinc-400 hover:bg-zinc-800 hover:text-white rounded-system font-black uppercase italic tracking-widest text-xs transition-all"
                        >
                            Manter Plano
                        </Button>
                        <Button
                            ...
                            className="flex-1 h-14 bg-red-600 hover:bg-red-500 text-white font-black uppercase italic tracking-widest text-xs rounded-system shadow-xl shadow-red-900/20 transition-all hover:scale-[1.02] active:scale-95 group"
                        >
