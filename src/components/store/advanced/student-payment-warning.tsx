        ...
        >
            <Stack gap={STORE_TOKENS.SPACING.CONTAINER}>
                <Font
                    ...
                    Notamos que o prazo de pagamento do seu plano com <Font
                    variant="description"
                    weight="bold"
                    {...{
                        color: STORE_TOKENS.COLORS.TEXT.PRIMARY,
                    }}>{relationship?.trainer?.full_name}</Font> venceu ou está próximo.
                </Font>
                    ...
                    <Stack gap={STORE_TOKENS.SPACING.ELEMENT}>
                        ...
                        <Stack direction="row" justify="between">
                            ...
                            <Font
                                ...
                                {...{
                                    color: STORE_TOKENS.COLORS.TEXT.PRIMARY,
                                }}>R$ {relationship?.monthly_fee?.toFixed(2)}</Font>
                        </Stack>
                    </Stack>
                </Surface>
