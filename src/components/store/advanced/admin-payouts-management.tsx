...
import { PayoutActionGroup } from '@/components/store/intermediary/payout-action-group'
                    ...
                    <Stack gap={STORE_TOKENS.SPACING.CONTAINER}>
                        {pendingPayouts.map(payout => (
                            <ActionableListCard
                                ...
                                footer={
                                    <Surface padding={STORE_TOKENS.PADDING.ELEMENT} rounded={STORE_TOKENS.RADIUS.SYSTEM} variant="tonal-emerald">
                                ...
                                <Stack direction="row" gap={STORE_TOKENS.SPACING.CONTAINER} align="center">
                                    ...
                                    <Stack gap={0} minWidth={0}>
                                        ...
                                        <Box fullWidth minWidth={0} overflow="hidden">
                                            <Font variant="sub-tiny" color={STORE_TOKENS.COLORS.TEXT.DIM} lowercase truncate display="block">
