...
export interface CardioManagementListProps {
    userId?: string
    cardios?: any[]
    students?: any[]
...
/**
 * CardioManagementList: Grid of premium cardio cards.
 */
export function CardioManagementList({
    userId = 'mock-id',
    cardios,
    students = [],
    mode = 'auto',
    isEmpty = false
}: CardioManagementListProps) {
