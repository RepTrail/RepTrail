    ...
    return (
        <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                {DAYS_SHORT.map((label, i) => {
                    ...
                    return (
                        <button
                            ...
                            disabled={disabled}
                            className={cn(
                                "w-5 h-5 rounded-md text-[8px] font-black transition-all border",
            ...
            <button
                ...
                disabled={disabled}
                className={cn(
                    "px-3 h-5 rounded-md text-[8px] font-black uppercase tracking-widest transition-all border w-fit",
...
export function PdfDataView({ 
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="bg-emerald-500/5 border border-emerald-500/10 p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    return (
                        <div key={`${idx}-${mIdx}`} className="bg-zinc-900/40 border border-zinc-800 rounded-2xl overflow-hidden">
                            <div className="bg-zinc-900/60 px-6 py-4 border-b border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                ...
                                <div className="flex gap-2 text-[9px] font-black text-emerald-500/70 bg-emerald-500/5 px-2 py-1 rounded-lg border border-emerald-500/10 uppercase tracking-widest w-fit">
                            ...
                            <div className="p-4 lg:p-6 space-y-3">
                                {m.foods?.length > 0 ? (
                                    m.foods.map((food, fIdx) => (
                                        <div key={fIdx} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 bg-zinc-950/20 border border-zinc-800/30 rounded-xl group hover:border-emerald-500/30 transition-all gap-3">
