...
export function ExerciseLoadChart({ data, exerciseName }: ExerciseLoadChartProps) {
    ...
    if (data.length === 0 || points.length === 0) {
        return (
            <div className="py-12 text-center bg-zinc-900/20 rounded-3xl border border-zinc-800/50 border-dashed">
    ...
    return (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                ...
                {weightEvolution !== 0 && (
                    <div className={`flex items-center gap-3 pb-4border  py-2 rounded-2xl ${weightEvolution > 0
            ...
            <div className="space-y-4">
                <div
                    ...
                    className="w-full overflow-x-auto overflow-y-hidden scrollbar-hide bg-zinc-900/30 rounded-[2rem] border border-zinc-800 p-6"
                >
            ...
            {/* Technical Note */}
            <div className="bg-zinc-900/40 p-5 rounded-3xl border border-zinc-800/50 backdrop-blur-sm space-y-3">
