                ...
                <div className="space-y-8 py-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <Textarea
                            ...
                            className="bg-zinc-900 border-zinc-800 rounded-2xl min-h-[120px] focus:border-amber-500/50 transition-all placeholder:text-zinc-700 font-medium text-white"
                            value={comment}
