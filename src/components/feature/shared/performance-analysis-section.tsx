    ...
    return (
        <Card className="bg-zinc-900/40 border-zinc-800/50 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-sm border-t-zinc-700/10">
            ...
            <CardContent className="p-8 md:p-12 pt-0">
                {isBlocked ? (
                    <div className="flex flex-col items-center justify-center py-20 text-center space-y-6 bg-zinc-950/50 rounded-[2rem] border border-dashed border-zinc-800">
                        ...
                        {!isStudentView && (
                            <Button asChild className="bg-emerald-500 text-zinc-950 hover:bg-emerald-600 font-black italic uppercase text-[10px] tracking-widest rounded-xl px-8 h-11 shadow-xl shadow-emerald-500/20 transition-all active:scale-95">
