                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                {mode === 'student' && isHovered && !isEditing && (
                                    <Button
                                        variant="ghost"
                                        size="icon"
                                        onClick={(e) => { e.stopPropagation(); handleDelete(item.setId); }}
                                        className="absolute top-2 right-2 h-7 w-7 bg-black/60 hover:bg-red-500 text-white border border-white/10 rounded-lg transition-all backdrop-blur-md opacity-0 group-hover:opacity-100"
                                    >
                                        <X className="w-4 h-4" />
                                    </Button>
                                )}
                            ...
                            {/* Date Controls (only for Student mode and front_url to avoid duplicate controls) */}
                            {mode === 'student' && activeFilter !== 'all' && (
                            ...
                            {/* If activeFilter is 'all', we show date controls only on specific types or sets */}
                            {mode === 'student' && activeFilter === 'all' && i % 4 === 0 && ( /* simplified logic for 'all' grid */
                                <div className="h-4" />
                            )}
                        </div>
                    )
