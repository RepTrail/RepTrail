            ...
            <div className="min-w-[500px] space-y-4">
                {rows.map(row => (
                    <div key={row.id} className="grid grid-cols-[90px_1fr] gap-4 items-center group">
                        ...
                        <div className="flex gap-1.5 h-7 items-center bg-zinc-900/30 p-1.5 rounded-xl border border-white/[0.02]">
                                    ...
                                    <TooltipProvider key={day.date}>
                                        <Tooltip delayDuration={0}>
                                            <TooltipTrigger asChild>
                                                <div className={cn(
                                                    "flex-1 h-full rounded-[4px] transition-all hover:scale-150 hover:z-50 cursor-crosshair",
                                                    colorClass
                                                )} />
                                            </TooltipTrigger>
                                            <TooltipContent side="top" className="bg-zinc-900 border-zinc-800 text-white text-[10px] p-3 rounded-2xl shadow-2xl backdrop-blur-xl">
