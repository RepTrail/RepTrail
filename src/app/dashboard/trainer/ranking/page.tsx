...
function RankingRow({ trainer, rank }: { trainer: any, rank: number }) {
    ...
    return (
        <div className="flex flex-col sm:flex-row sm:items-center p-4 sm:p-6 hover:bg-zinc-900/50 transition-all group gap-4">
            <div className="flex items-center gap-4 flex-1">
                <div className="w-8 flex-shrink-0 text-zinc-600 font-black italic text-lg group-hover:text-zinc-400">
                    #{rank}
                </div>
            ...
            <div className="flex items-center justify-between sm:justify-end gap-4 md:gap-8 ml-0 sm:ml-4">
                ...
                {trainer.trainer_code ? (
                    <Link href={`/personal/${trainer.trainer_code}`} className="flex-shrink-0">
                        <Button variant="outline" className="h-10 px-4 rounded-xl border-zinc-800 bg-transparent hover:bg-emerald-500 hover:text-zinc-950 hover:border-emerald-500 text-white font-bold uppercase italic tracking-wide transition-all group/btn">
                            ...
                            <ArrowRight className="w-3 h-3 xs:ml-2 group-hover/btn:translate-x-1 transition-transform" />
                        </Button>
                    </Link>
                ) : (
                    <Button disabled variant="outline" className="h-10 rounded-xl border-zinc-800 bg-transparent text-zinc-700 font-bold uppercase italic tracking-wide cursor-not-allowed">
