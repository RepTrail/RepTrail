            ...
            <Stack gap={10}>
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="space-y-1">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-widest leading-none">Status de Parceiro</p>
                        <div className="flex items-center gap-2 px-3 py-1 bg-zinc-950/80 border border-zinc-800 w-fit rounded-full">
                            <Flame className="w-3 h-3 text-orange-500" />
                            <span className="text-[10px] font-black text-white uppercase tracking-widest">Growth Supplements • Oficial</span>
                        </div>
                    </div>
                ...
                {!loading && filteredProducts.length === 0 && (
                    <div className="py-20">
                        <EmptyState 
                            icon={ShoppingBag} 
                            title="Nenhum tesouro encontrado" 
                            description="Tente buscar por termos mais genéricos ou verifique as categorias." 
                        />
                    </div>
                )}
            </Stack>
