...
export default async function MeuPersonalPage() {
    ...
    return (
        <RegistryMain
            title="MEU PERSONAL"
            subtitle="Seu treinador de confiança. Acompanhe protocolos e entre em contato."
            icon={UserCheck}
            ...
            <Stack gap={10}>
                ...
                {(trainerRel.monthly_fee || trainerRel.payment_day) && (
                    <div className="p-8 bg-zinc-900/30 border border-zinc-800/50 rounded-[2.5rem] space-y-4">
                        <h3 className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.3em]">Detalhes do Contrato</h3>
                        <Grid gap={4} smCols={2}>
