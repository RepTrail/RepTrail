-- Migration to setup Affiliate System and update New User Trigger
-- Consolidated version 2026-02-19

-- 0. Ensure helper function for Trainer Code exists (from previous migration)
...
DROP POLICY IF EXISTS "Affiliates can insert own payouts" ON public.affiliate_payouts;
